%IVGPMF  Computes the continuous-time MISO model parameters from regularly
%   or irregularly sampled I/O data by the Auxiliary Model
%   Instrumental-Variable Generalized Poisson Moment Functional approach.
%
%   Syntax :
%
%      [M,ice] = IVGPMF(Z,nn,lambda)
%      [M,ice] = IVGPMF(Z,nn,lambda,'Name',Value)
%
