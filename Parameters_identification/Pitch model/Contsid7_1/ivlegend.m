%IVLEGEND	Computes the continuous-time SISO model parameters from sampled I/O data
%		by Auxiliary Model Instrumental-Vector Legendre's orthogonal polynomials technique.
%
%	Syntax : 	 [M,ice]=ivlegend(Z,nn,r);
%
...
%
% r    : Legendre's orthogonal polynomial order
