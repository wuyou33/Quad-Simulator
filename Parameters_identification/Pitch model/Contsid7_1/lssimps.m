%LSSIMPS	Computes the continuous-time SISO model parameters from sampled I/O
%		data using the Least-Squares Simpson's rule integration method.
%
%	Usage :     [M,ice]=lssimps(Z,nn)
%
