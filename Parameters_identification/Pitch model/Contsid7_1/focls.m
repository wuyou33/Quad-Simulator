%   FOCLS -- Computes the continuous-time SISO EIV model parameters
%   from regular sampled I/O data by the Least Squares method
%   using fourth-order cumulants (input of the system must
%   have a non-Gaussian distribution, the noises a Gaussian distribution).
%
%	Syntax :
%       [model] = focls(data,nn,M,lambda,tol);
%
%   Outputs:
