%RIVSVF  Estimates recursively the parameters of a LTI or LTV system
%   using the IVSVF method.
%
%   Syntax :
%
%      [THM,YHAT] = RIVSVF(data,nn,lambda)
%      [THM,YHAT] = RIVSVF(data,nn,lambda,'Name',Value)
%
...
%   Afterwards, the recursive IVSVF estimates are computed. Notice also
%   that the instrument is updated at 3*N/5, where N is the number of
%   data.
%
