%LSCHEBY1	Computes the continuous-time SISO model parameters from sampled I/O data
%		by Least-Squares 1st kind Chebyshev's orthogonal polynomials technique.
%
