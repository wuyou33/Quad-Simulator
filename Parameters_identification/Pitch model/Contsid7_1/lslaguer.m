%LSLAGUER	Computes the continuous-time SISO model parameters from sampled I/O data
%		by Least-Squares Laguerre's orthogonal polynomials technique.
%
%	Usage : 	 [M,ice]=lslaguer(Z,nn,r);
%
