%IVCHEBY1	Computes the continuous-time SISO model parameters from sampled I/O data
%		by Auxiliary Model Instrumental-Vector 1st kind Chebyshev's orthogonal
%		polynomials technique.
%
%	Syntax : 	 [M,ice]=ivcheby1(Z,nn,r);
%
