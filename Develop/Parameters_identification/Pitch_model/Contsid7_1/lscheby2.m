%LSCHEBY2	Computes the continuous-time SISO model parameters from sampled I/O data
%		by Least-Squares 2nd kind Chebyshev's orthogonal polynomials technique.
%
%	Usage : 	 [M,ice]=lscheby1(Z,nn,r);
%
