%IVHERMIT	Computes the continuous-time SISO model parameters from sampled I/O data
%		by Auxiliary Model Instrumental-Vector Hermite's orthogonal polynomials technique.
%
%	Syntax : 	 [M,ice]=ivhermit(Z,nn,r);
%
...
%
% r    : Hermite's orthogonal polynomial order
