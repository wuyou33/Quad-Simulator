%LSTPF	Computes the continuous-time SISO model parameters from sampled I/O
%	data using the Least-Squares Trapezoidal Pulse-Function integration method.
%
%	Usage :     [M,ice]=lstpf(Z,nn)
%
