%LSHERMIT	Computes the continuous-time SISO model parameters from sampled I/O data
%		by Least-Squares Hermite's orthogonal polynomials technique.
%
%	Usage : 	 [M,ice]=lshermit(Z,nn,r);
%
