%LSLEGEND	Computes the continuous-time SISO model parameters from sampled I/O data
%		by Least-Squares Legendre's orthogonal polynomials technique.
%
%	Usage : 	 [M,ice]=lslegend(Z,nn,r);
%
