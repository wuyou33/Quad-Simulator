%IVFLBF  Computes the continuous-time MISO model parameters from sampled I/O data
%	 by the basic Instrumental Variable based Frequency Localising Basis Function approach.
%
%	Syntax :     [M,ice]=ivflbf(Z,nn,w_basis,n0,'ic')
%
