...
Ixx = 0.011382;% ± 0.0013714     %[kg*m^2] Inertia around Xbody axes
Iyy = 0.011382;% ± 0.0013714     %[kg*m^2] Inertia around Ybody axes
...
Kq = Cq*ro*A*R^3;
%dMdu = 2*sqrt(2)*Kt*b;
dMdu = 1.2814e-05;% ± 2.1946e-06 %[Nm*s] Control derivative

%Aerodynamic damping
dMdq = -0.030747;% ± 0.00072073  %[Nm*s] Stability derivative of the vehicle pitch
dLdp = dMdq;
dLMN = [dLdp  0   0  ;
         0   dMdq 0  ;
         0    0   0 ];
