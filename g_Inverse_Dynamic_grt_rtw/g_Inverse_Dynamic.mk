...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/g_Inverse_Dynamic
...
PRODUCT_NAME              = g_Inverse_Dynamic
MAKEFILE                  = g_Inverse_Dynamic.mk
COMPUTER                  = GLNXA64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = g_Inverse_Dynamic_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/g_Inverse_Dynamic
...
INCLUDES_BUILDINFO = -I$(START_DIR)/g_Inverse_Dynamic_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=g_Inverse_Dynamic -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/g_Inverse_Dynamic_grt_rtw/g_Inverse_Dynamic.cpp $(MATLAB_ROOT)/rtw/c/src/common/rt_cppclass_main.cpp
...
%.o : $(START_DIR)/g_Inverse_Dynamic_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/g_Inverse_Dynamic_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
