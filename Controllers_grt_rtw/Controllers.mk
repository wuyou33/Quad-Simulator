...
## Generated on : Sat Oct 31 18:42:52 2015
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Controllers
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Controllers_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Controllers
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Controllers_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Controllers -DNUMST=2 -DNCSTATES=5 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/Controllers_grt_rtw/Controllers.cpp $(MATLAB_ROOT)/rtw/c/src/common/rt_cppclass_main.cpp
...
%.o : $(START_DIR)/Controllers_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Controllers_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
