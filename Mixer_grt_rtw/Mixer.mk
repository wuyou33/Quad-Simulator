###########################################################################
## Makefile generated for Simulink model 'Mixer'. 
## 
## Makefile     : Mixer.mk
## Generated on : Sat Oct 31 18:43:56 2015
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Mixer
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Mixer_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Mixer
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Mixer_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Mixer -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/Mixer_grt_rtw/Mixer.cpp $(MATLAB_ROOT)/rtw/c/src/common/rt_cppclass_main.cpp
...
%.o : $(START_DIR)/Mixer_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Mixer_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
