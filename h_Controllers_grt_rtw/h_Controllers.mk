...
## Generated on : Wed Oct 28 20:12:38 2015
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/h_Controllers
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = h_Controllers_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/h_Controllers
...
INCLUDES_BUILDINFO = -I$(START_DIR)/h_Controllers_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=h_Controllers -DNUMST=2 -DNCSTATES=5 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/h_Controllers_grt_rtw/h_Controllers.cpp $(MATLAB_ROOT)/rtw/c/src/common/rt_cppclass_main.cpp
...
%.o : $(START_DIR)/h_Controllers_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/h_Controllers_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
